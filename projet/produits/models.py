...
class produits(models.Model):
    ...
    latitude = models.DecimalField(max_digits=100, decimal_places=100, blank=True, null=True)
    longitude = models.DecimalField(max_digits=100, decimal_places=100, blank=True, null=True)
